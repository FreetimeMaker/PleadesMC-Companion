...
import com.freetime.pmcc.databinding.FragmentScmdBinding;

public class ServerCMDFragment extends Fragment {

    private FragmentScmdBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentScmdBinding.inflate(inflater, container, false);
